...
public class RealtimeRoom {
    ...
    private static final Logger LOGGER = Logger.getLogger(RealtimeRoom.class.getName());
...
//    private Ref<Peer> ownerRef;
    ...
    public RealtimeRoom(String name, boolean staticRoom) {
        this(name,  DEFAULT_MAX_USERS, Collections.EMPTY_LIST, staticRoom);
    }

    public RealtimeRoom(String name, long id) {
        this(name, -1, Collections.EMPTY_LIST, false);
        this.id = id;
        this.staticRoom = true;
    }

    public RealtimeRoom(String name, int maxUsers, List<Peer> peers, boolean staticRoom) {
        this.name = name;
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        final RealtimeRoom other = (RealtimeRoom) obj;
