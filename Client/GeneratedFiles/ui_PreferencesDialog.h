...
public:
    ...
    void setupUi(QDialog *IODialog)
    {
        ...
        gridLayout->addWidget(widgetBottom, 1, 0, 1, 1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 60, 165));
        ...
        gridLayout->addWidget(prefsTab, 0, 0, 1, 1);


        retranslateUi(IODialog);

        okButton->setDefault(false);
        prefsTab->setCurrentIndex(3);
