...
public:
    ...
    QAction *actionReport_bugs_or_suggest_improvements;
    ...
    void setupUi(QMainWindow *MainFrameClass)
    {
        ...
        actionReport_bugs_or_suggest_improvements = new QAction(MainFrameClass);
        actionReport_bugs_or_suggest_improvements->setObjectName(QStringLiteral("actionReport_bugs_or_suggest_improvements"));
        ...
        menuHelp->addAction(actionReport_bugs_or_suggest_improvements);
    ...
    void retranslateUi(QMainWindow *MainFrameClass)
    {
        ...
        actionReport_bugs_or_suggest_improvements->setText(QApplication::translate("MainFrameClass", "Report bugs or suggest improvements ...", 0));
        ...
        menuThemes->setTitle(QApplication::translate("MainFrameClass", "Themes", 0));
