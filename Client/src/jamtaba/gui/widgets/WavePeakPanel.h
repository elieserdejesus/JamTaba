...
public:
    ...
    inline QColor getPeaksColor() const{return peaksColor;}

    inline int getRoundBorderSize() const{return roundBorderSize;}

    void setBorderColor(QColor borderColor) ;

    void setDrawBorder(bool drawBorder) ;

    inline bool isDrawBorder() const{return drawBorder;}
