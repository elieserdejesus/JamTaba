...
public:
    ...
    void setupUi(QWidget *BaseTrackView)
    {
        ...
        boostPanel = new QGroupBox(BaseTrackView);
        boostPanel->setObjectName(QStringLiteral("boostPanel"));
        horizontalLayout = new QHBoxLayout(boostPanel);
        ...
        horizontalLayout->addWidget(buttonBoostMinus12);
        ...
        horizontalLayout->addWidget(buttonBoostZero);
        ...
        horizontalLayout->addWidget(buttonBoostPlus12);


        mainLayout->addWidget(boostPanel);
...
#endif // QT_NO_TOOLTIP
        buttonBoostMinus12->setText(QApplication::translate("BaseTrackView", "-12db", 0));
#ifndef QT_NO_TOOLTIP
        buttonBoostZero->setToolTip(QApplication::translate("BaseTrackView", "no boost", 0));
#endif // QT_NO_TOOLTIP
        buttonBoostZero->setText(QApplication::translate("BaseTrackView", "0 db", 0));
#ifndef QT_NO_TOOLTIP
        buttonBoostPlus12->setToolTip(QApplication::translate("BaseTrackView", "+12 db boost", 0));
#endif // QT_NO_TOOLTIP
        buttonBoostPlus12->setText(QApplication::translate("BaseTrackView", "+12db", 0));
    } // retranslateUi
