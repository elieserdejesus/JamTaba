...
public:
    ...
    void setupUi(QWidget *NinjamPanel)
    {
        ...
        horizontalLayout_4->setContentsMargins(12, 12, 12, 9);
        ...
        sizePolicy3.setHeightForWidth(soloButton->sizePolicy().hasHeightForWidth());
        soloButton->setSizePolicy(sizePolicy3);
