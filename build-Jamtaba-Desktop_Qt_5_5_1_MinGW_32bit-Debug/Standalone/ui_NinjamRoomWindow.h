...
public:
    ...
    void setupUi(QWidget *NinjamRoomWindow)
    {
        ...
        contentLayout->setContentsMargins(9, 6, -1, 0);
        ...
        tracksPanel->setGeometry(QRect(0, 0, 727, 385));
    ...
    void retranslateUi(QWidget *NinjamRoomWindow)
    {
        ...
        NinjamRoomWindow->setAccessibleDescription(QApplication::translate("NinjamRoomWindow", "you are in the ninjam room window", 0));
#endif // QT_NO_ACCESSIBILITY
#ifndef QT_NO_ACCESSIBILITY
        labelRoomName->setAccessibleDescription(QApplication::translate("NinjamRoomWindow", "This is the room where you are", 0));
#endif // QT_NO_ACCESSIBILITY
