...
#include "../../../Client/src/audio/core/AudioDriver.h"
...
struct qt_meta_stringdata_Audio__NullAudioDriver_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Audio__NullAudioDriver_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Audio__NullAudioDriver_t qt_meta_stringdata_Audio__NullAudioDriver = {
    {
QT_MOC_LITERAL(0, 0, 22) // "Audio::NullAudioDriver"

    },
    "Audio::NullAudioDriver"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Audio__NullAudioDriver[] = {
...
void Audio::NullAudioDriver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject Audio::NullAudioDriver::staticMetaObject = {
    { &AudioDriver::staticMetaObject, qt_meta_stringdata_Audio__NullAudioDriver.data,
      qt_meta_data_Audio__NullAudioDriver,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *Audio::NullAudioDriver::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *Audio::NullAudioDriver::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_Audio__NullAudioDriver.stringdata0))
        return static_cast<void*>(const_cast< NullAudioDriver*>(this));
    return AudioDriver::qt_metacast(_clname);
}

int Audio::NullAudioDriver::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = AudioDriver::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
