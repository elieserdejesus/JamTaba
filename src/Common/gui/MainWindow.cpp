...
void MainWindow::setUserNameReadOnlyStatus(bool readOnly)
{
    ...
    QString toolTip = readOnly ? tr("Your name cannot be edited while jamming!") : "Only Letters, numbers, hyphen and underscore allowed! Spaces will be replaced by an underscore.";
