...
public:
    ...
    void savePreset(const persistence::LocalInputTrackSettings &inputsSettings,
                    const QString &name);
    ...
    void enterInRoom(const login::RoomInfo &room, const QStringList &channelsNames,
...
protected:
    ...
    virtual void doAudioProcess(const audio::SamplesBuffer &in, audio::SamplesBuffer &out,
                                int sampleRate);
