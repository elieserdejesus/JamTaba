...
#include "../../Client/src/jamtaba/audio/vst/PluginFinder.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Vst__PluginFinder_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 61, 24), // "Audio::PluginDescriptor*"
QT_MOC_LITERAL(6, 86, 16) // "pluginDescriptor"

    },
    "Vst::PluginFinder\0scanStarted\0\0"
    "scanFinished\0vstPluginFounded\0"
    "Audio::PluginDescriptor*\0pluginDescriptor"
};
...
void Vst::PluginFinder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->vstPluginFounded((*reinterpret_cast< Audio::PluginDescriptor*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (PluginFinder::*_t)(Audio::PluginDescriptor * );
...
void *Vst::PluginFinder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Vst__PluginFinder.stringdata))
...
// SIGNAL 2
void Vst::PluginFinder::vstPluginFounded(Audio::PluginDescriptor * _t1)
{
