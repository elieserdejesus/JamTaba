...
#include "../../Client/src/jamtaba/gui/ChatPanel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ChatPanel_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 37, 23), // "chatTextEditionFinished"
QT_MOC_LITERAL(5, 61, 29), // "verticalScrollBarRangeChanged"
QT_MOC_LITERAL(6, 91, 3), // "min"
QT_MOC_LITERAL(7, 95, 3) // "max"

    },
    "ChatPanel\0userSendingNewMessage\0\0msg\0"
    "chatTextEditionFinished\0"
    "verticalScrollBarRangeChanged\0min\0max"
};
...
void ChatPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->chatTextEditionFinished(); break;
        case 2: _t->verticalScrollBarRangeChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
...
void *ChatPanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChatPanel.stringdata))
