...
#include "../../Client/src/jamtaba/gui/ChatMessagePanel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ChatMessagePanel_t, stringdata) + ofs \
...
void *ChatMessagePanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ChatMessagePanel.stringdata))
