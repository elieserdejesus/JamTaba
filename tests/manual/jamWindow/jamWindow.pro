...
SOURCES += $$SRC/Libs/RtMidi/RtMidi.cpp
...
INCLUDEPATH += $$ROOT/libs/includes/ffmpeg
INCLUDEPATH += $$ROOT/libs/includes/vorbis
INCLUDEPATH += $$ROOT/libs/includes/ogg
INCLUDEPATH += $$ROOT/libs/includes/portaudio
INCLUDEPATH += $$ROOT/libs/includes/rtmidi
INCLUDEPATH += $$ROOT/libs/includes/minimp3
INCLUDEPATH += $$ROOT/libs/includes/stackwalker

INCLUDEPATH += $$ROOT/VST_SDK/pluginterfaces/vst2.x
...
FORMS += Common/gui/MetronomePanel.ui
...
HEADERS += Common/gui/MetronomePanel.h
...
HEADERS += Common/gui/InactivityDetector.h
...
HEADERS += Common/gui/widgets/ChatTabWidget.h

HEADERS += Common/gui/chords/ChordProgression.h
HEADERS += Common/gui/chords/ChatChordsProgressionParser.h
...
#HEADERS += Common/midi/MidiDriver.h
#HEADERS += Common/midi/RtMidiDriver.h
...
HEADERS += Common/gui/chat/EmojiManager.h
HEADERS += Common/gui/chat/EmojiWidget.h
...
SOURCES += Common/gui/InactivityDetector.cpp
...
SOURCES += Common/gui/widgets/ChatTabWidget.cpp
...
SOURCES += Common/gui/chat/EmojiManager.cpp
SOURCES += Common/gui/chat/EmojiWidget.cpp

SOURCES += Common/gui/IconFactory.cpp
SOURCES += Common/gui/MetronomePanel.cpp
...
CONFIG(release, debug|release):    LIBS += -L$$LIBS_PATH -lportaudio -lminimp3 -lvorbisfile -lvorbis -logg -lavcodec -lavutil -lavformat -lswscale -lswresample -lstackwalker
else:CONFIG(debug, debug|release): LIBS += -L$$PWD/$$ROOT/libs/$$LIBS_PATH/ -lportaudiod -lminimp3d -lvorbisfiled -lvorbisd -loggd -lavcodecd -lavutild -lavformatd -lswscaled -lswresampled -lstackwalkerd
