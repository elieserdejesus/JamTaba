...
QT_MOC_LITERAL(4, 37, 26), // "on_chatTextEditionFinished"
QT_MOC_LITERAL(5, 64, 32), // "on_verticalScrollBarRangeChanged"
QT_MOC_LITERAL(6, 97, 3), // "min"
QT_MOC_LITERAL(7, 101, 3), // "max"
QT_MOC_LITERAL(8, 105, 22) // "on_buttonClear_clicked"

    },
    "ChatPanel\0userSendingNewMessage\0\0msg\0"
    "on_chatTextEditionFinished\0"
    "on_verticalScrollBarRangeChanged\0min\0"
    "max\0on_buttonClear_clicked"
};
...
void ChatPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_chatTextEditionFinished(); break;
        case 2: _t->on_verticalScrollBarRangeChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
