...
win32 {
    ...
    CONFIG(release, debug|release): LIBS += -lQt5FontDatabaseSupport
    CONFIG(release, debug|release): LIBS += -lQt5EventDispatcherSupport
    CONFIG(release, debug|release): LIBS += -lQt5ThemeSupport
    CONFIG(release, debug|release): LIBS += -lQt5PlatformCompositorSupport
    CONFIG(release, debug|release): LIBS += -lQt5AccessibilitySupport
    #CONFIG(release, debug|release): LIBS += -lQt5WindowsUiAutomationSupport
    CONFIG(release, debug|release): LIBS += -lqtfreetype
    ...
    #debug platform libs
    CONFIG(debug, debug|release): LIBS += -lQt5FontDatabaseSupportd
    CONFIG(debug, debug|release): LIBS += -lQt5EventDispatcherSupportd
    CONFIG(debug, debug|release): LIBS += -lQt5ThemeSupportd
    CONFIG(debug, debug|release): LIBS += -lQt5PlatformCompositorSupportd
    CONFIG(debug, debug|release): LIBS += -lQt5AccessibilitySupportd
    #CONFIG(debug, debug|release): LIBS += -lQt5WindowsUiAutomationSupportd
    CONFIG(debug, debug|release): LIBS += -lqtfreetyped
