...
HEADERS += looper/AudioLooper.h
HEADERS += looper/AudioLooperLayer.h
HEADERS += looper/AudioLooperStates.h
...
SOURCES += looper/AudioLooper.cpp
SOURCES += looper/AudioLooperLayer.cpp
SOURCES += looper/AudioLooperStates.cpp
